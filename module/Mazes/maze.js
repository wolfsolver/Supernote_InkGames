// import {buildEventTarget} from './utils'; // Removed to avoid ReferenceError: EventTarget
import {
...
// const eventTarget = buildEventTarget('maze'); // Removed
...
function buildBaseGrid(config) {
    ...
    return {
        ...
        on(eventName, handler) {
            // eventTarget.on(eventName, handler); // Disabled
        },
...
export function buildSquareGrid(config) {
    ...
    /* Removed click handler dependence on EventTarget/DrawingSurface events
