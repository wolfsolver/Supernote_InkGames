const maze = {}; // Dichiarazione diretta dell'oggetto


'use strict';

// priorityjs minimal mock
var PriorityQ = function (comparator) {
  this.items = [];
...
Backtracker.prototype.solve = function (start, end) {
  var pq = new PriorityQ(function (a, b) {
    // Invertiamo per avere la coda di priorità (pop prende il maggiore, quindi mettiamo il punteggio minore in fondo se vogliamo quello con score minore?)
    // Nella logica originale: a.score < b.score. Pop() prende l'ultimo.
    // Se vogliamo il minore, sort deve mettere il minore in fondo? No, sort decrescente.
